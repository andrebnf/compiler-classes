...
public class Compiler {
  ...
  // BreakStmt ::= 'break' ';'
  // TODO breakStmt received an instance of whileStmt
  ...
  private Expr expr() {
    ...
    if (expr.getRelOp() != null){
      ...
      // SEM - if Expr::SimExpr::Term::Factor::LValue is the only present object
      // TODO - NOT WORKING
//      if (expr.hasOnlySimExpr().hasOnlyTerm().hasOnlyFactor().hasOnlyOneSideValue()) {
//        error.signal("Found value without attribution");
//      }
    }
